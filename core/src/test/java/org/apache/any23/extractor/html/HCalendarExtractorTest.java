...
public class HCalendarExtractorTest extends AbstractExtractorTestCase {
    ...
    public void testOneVEvent() throws Exception {
        ...
        try {
            while (result.hasNext()) {
                ...
                assertContains(subject, vICAL.uid, "19970901T130000Z-123401@host.com");
    ...
    public void testTransparentEvent() throws Exception {
        ...
        try {
            while (result.hasNext()) {
                ...
                assertContains(subject, vICAL.uid, "19970901T130000Z-123402@host.com");
                assertContains(subject, vICAL.summary, "Laurel is in sensitivity awareness class.");
    ...
    public void testRepetitiveEvent() throws Exception {
        ...
        try {
            while (result.hasNext()) {
                ...
                assertContains(subject, vICAL.summary, "Our Blissful Anniversary");
    ...
    public void test05() throws Exception {
        ...
        assertContains(event, vICAL.url, RDFUtils.iri("http://www.web2con.com/"));
    ...
    public void test06() throws Exception {
        ...
        assertContains(event, vICAL.url, RDFUtils.iri(baseIRI + "squidlist/calendar/12279/2006/1/15"));
    }
    ...
    public void test09() throws Exception {
        ...
        assertContains(event, vICAL.url, RDFUtils.iri("http://conferences.oreillynet.com/et2006/"));
    ...
    public void test13() throws Exception {
        ...
        Resource event = getExactlyOneComponent(vevent);
        assertContains(event, vICAL.url, RDFUtils
                .iri("http://dps1.travelocity.com/dparcobrand.ctl?smls=Y&Service=YHOE&.intl=us&aln_name=AA&flt_num="
    ...
    @Test
    public void testNoMicroformatsInStatCvsPage() throws Exception, IOException, ExtractionException {
