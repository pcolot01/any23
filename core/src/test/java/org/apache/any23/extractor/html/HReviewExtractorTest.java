...
public class HReviewExtractorTest extends AbstractExtractorTestCase {
            ...
            while (reviews.hasNext()) {
                ...
                try {
                    while (reviewSubjects.hasNext()) {
                        ...
                        assertContains(reviewSubject, vVCARD.url, RDFUtils.iri("http://www.imdb.com/title/tt0299977/"));
                    }
    ...
    /**
     * This test is the same defined in {@link HReviewExtractorTest#test04NoHcardForItem} but assess the behavior in
     * presence of a <i>Microformat</i> name with a different letter capitalization.
     *
     * @throws Exception
